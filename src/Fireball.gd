...
func _on_Tween3_tween_all_completed():
	$Tween4.interpolate_property($TextureRect/Sprite3, "modulate",Color(1, 1, 1, 0), Color(1, 1, 1, 1), 1, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween4.start()
...
func _on_Tween5_tween_all_completed():
	$Tween6.interpolate_property($Label, "percent_visible", 0, 1, 0.5, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween6.start()


func _on_Tween6_tween_all_completed():
	set_process(true)
